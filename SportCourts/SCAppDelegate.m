...
@interface SCAppDelegate () <MSDynamicsDrawerViewControllerDelegate>
...
- (void)initWindowWithDynamicsDrawer {
    ...
    // Находим контроллер меню
    SCMenuViewController *menuViewController = [self.window.rootViewController.storyboard instantiateViewControllerWithIdentifier:@"Menu"];
    ...
    [UIView transitionWithView:self.window
                    ...
                    animations:^{ self.window.rootViewController = self.dynamicsDrawerViewController; }
                    completion:nil];
    
    # warning недоделаный фон для меню
    // добавляем фон для меню
...
//    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.sportcourts.SportCourts" in the application's documents directory.
...
//    }
//    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"SportCourts" withExtension:@"momd"];
...
//    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SportCourts.sqlite"];
//    NSError *error = nil;
